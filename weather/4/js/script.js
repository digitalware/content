...
function getMainWeatherImage(iconCode){
    ...
    /* 안개 */
        ...
        console.log('안개 - 18main.png 반환');
        return 'images/18main.png';
    }

    /* 천둥 */
    else if(iconCode.startsWith('11')){
        console.log('천둥 - 19main.png 반환');
        return 'images/19main.png';
    }

    /* 눈 */
    else if(iconCode.startsWith('13')){
        console.log('눈 - 22main.png 반환');
        return 'images/22main.png';
    }
